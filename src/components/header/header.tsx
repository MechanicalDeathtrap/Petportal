  ...
  const togglePopperAnchorElement = (
    ...
    if (type === "account") {
      if (accountPopperAnchorEl) {
        ...
        setAccountPopperAnchorEl(e.currentTarget);
        if (notificationPopperAnchorEl) {
          setNotificationPopperAnchorEl(null);
        }
      }
    } else {
      if (notificationPopperAnchorEl) {
        ...
        setNotificationPopperAnchorEl(e.currentTarget);
        if (accountPopperAnchorEl) {
          setAccountPopperAnchorEl(null);
        }
      }
        ...
        <div className={styles.profileButtons}>
          <ul className={styles.headerButtonsList}>
            <li>
              <button
                ...
                onClick={(e) => {
                  togglePopperAnchorElement(e, "notification");
                  popupStore.toggleNotificationPopupOpen();
                }}
              >
                <svg
          ...
          {authStore.isAuthorized ? (
            <button
              type="button"
              onClick={(e) => {
                togglePopperAnchorElement(e, "account");
