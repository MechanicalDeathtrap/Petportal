...
export const CreateProject = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    deadline: Yup.date()
      .min(
        Yup.ref("applyingDeadline"),
        "Срок выполнения должен быть позже срока приёма заявок",
      )
            ...
            <Form className={style["create-project__form"]}>
              <label>
                ...
                {errors.name && touched.name && (
                  <div style={{ position: "relative" }}>
                    <div className={style["create-project__form--error"]}>
                      {errors.name}
                    </div>
                  </div>
                )}
                <span className={style["create-project__form-chars-number"]}>
                  {charCounts["name"]} / 100
                </span>
              </label>
              ...
              <label>
                ...
                <Field
                  ...
                  as="textarea"
                  name="description"
                  placeholder="Развернуто опишите задачу"
                  className={style["create-project__form-field"]}
                  onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) =>
              ...
              <label>
                ...
                <div>
                  <button type="button" onClick={() => setInputTag("")}>
                    + Тег
                  </button>
              ...
              <label>
                ...
                <Field
                  ...
                  placeholder="Напишите, кого вы ищите"
                  className={style["create-project__form-field"]}
                  onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) =>
                ...
                <span className={style["create-project__form-chars-number"]}>
                  {charCounts["teamDescription"]} / 300
                </span>
              </label>
