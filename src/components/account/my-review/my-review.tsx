          ...
          <ul className={style["my-review__reviews-list"]}>
            <li className={style["my-review__review-container"]}>
              ...
              <div className={style["my-review__review-info"]}>
                ...
                <p>
                  Ахуенный челик круто выполняет обязанности пиздеть не мешки
                  воротить как говориться рот я его того суда сюда камыш норма
                  права государство организация публичной пвласти демократия
                  автократия суверенитет образование детка ты выполнила 5 5 5 5
                  7 восемь
                </p>
              </div>
            </li>
